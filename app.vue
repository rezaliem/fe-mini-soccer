...
const themeOverrides = {
  common: {
    ...
    baseColor: "#FFF",
    primaryColor: "#b0914f",
    primaryColorHover: "#b8964f",
    primaryColorPressed: "#907336",
    primaryColorSuppl: "#b8964f",
    infoColor: "#2080f0",
...
useHead({
  title: "INFT",
  titleTemplate: "%s | INFT Admin Dashboard",
  meta: [
    {
      name: "description",
      content:
        "Asia's First Community-Driven Digital Business Account. A New Way to Send, Spend, Manage and Access Money",
    },
  ],
  link: [
    // {
